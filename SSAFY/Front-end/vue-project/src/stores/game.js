...
export const useGameStore = defineStore('gameInfo', () => { 
    ...
    // 뉴 스포츠 정보
    const gameInfo = ref([
        {id: 1, koName: "티볼", enName: "Tee-Ball", info:"전문적인 기술과 장소,도구 등을 사용하지 않고도 야구형 스포츠의 흥미를 남녀노소 누구나 안전하게 즐길 수 있도록 고안된 경기이다. 티 위에 공을 올려놓고 치는 게임으로서 결과에 대한 기쁨이나 책임도 모두에게 골고루 돌아간다.티볼은 안전한 공과 베트,작은경기장, 쉬운 기술 등을 이용해 누구나 쉽게 야구형 팀 스포츠에 참가 할 수 있게 하여 야구의 즐거움을 만끽할 수 있다.", rulesUrl: "https://www.youtube.com/watch?v=FD72fVvoeX0", videoUrl: "https://www.youtube.com/watch?v=UpZxh9Z3iYQ"}, 
        {id: 2, koName: "빅발리볼", enName: "Vic-Volleyball", info: "빅발리볼은 배구와 같이 비어있는 상대편 코트로 공을 넘겨 득점하는 배구형 스포츠이다. 배구공보다 크고(지름 약 50cm) 가벼운 빅발리볼을 이용하므로 더 안전하고 쉽게 배울 수 있으며 배트민턴 네트를 이용하여 게임할 수도 있다.", rulesUrl: "https://www.youtube.com/watch?v=JiyXdVsRE30", videoUrl: "https://www.youtube.com/watch?v=I_xRiSVpdIw"}, 
        {id: 3, koName: "인디아카", enName: "Indiaca", info: "인디아카는 배구와 배트민턴, 그리고 탁구의 재미를 라켓이 아닌 손바닥으로 직접 인디아카를 상대편에 넘기는 뉴스포츠이다. 6인제 배구의 규정에 의해 인디아카를 맨손으로 쳐서 상대팀의 코트에 넘김으로서 득점을 하는 게임이다. 배구와 배드민턴의 리드업 게임으로서 배구나 배드민턴의 기본기를 익히는데 매우 효과적이다. 독일에서 탄생한 인디아카는 유럽은 물론, 중국, 일본 등에서도 널리 알려지고 있으며 노인체육종목으로서도 각광을 받는 종목이기도 하다.", rulesUrl: "https://www.youtube.com/watch?v=39_213D6coQ", videoUrl: null}, 
        {id: 4, koName: "츄크볼", enName: "Tchouball", info: "츄크볼은 1920년에 스위스의 생물학자 H.브랜드리가 팀 게임의 과학적 비판이라는 논문에서 종래의 구기운동을 침략적이라고 규정하고 그 대안으로 비침략적인 게임을 구상하면서 만들어졌다 탄력성이 있는 약 1M의 네트에 볼을 던져 튀어 오른 볼이 상대팀에게 잡히지 않도록 하는 경기이다. 학교 수업에서는 핸드볼의 리드 업 게임으로 적극 활용할 가치가 있다. 일반적인 팀 게임과의 큰 차이는 상대의 볼을 빼앗거나 방해해서는 안 된다는 점이다. 그 때문에 구기에 익숙하지 않았던 사람들도 쉽게 즐길 수 있다. 그러나 상대팀의 움직임이나, 슛된 볼의 낙하지점을 예측하면서 움직이는 것이 요구되는 스포츠이다.", rulesUrl: "https://www.youtube.com/watch?v=HkS8fY-se9E", videoUrl: "https://www.youtube.com/watch?v=ow7YRheQbp8"}, 
        {id: 5, koName: "플로어볼", enName: "Floorball", info: "플로어볼은 하키형 뉴스포츠이다. 무겁고 딱딱한 스틱 대신 플라스틱으로 만들어진 가볍고 안전한 스틱으로 경기를 진행합니다. 볼은 플라스틱제의 가볍고 안전한 소재로 제작되었다. 유럽에서는 다양한 지역대회를 개최할 정도로 많이 소개되고 아시아권에서도 일본, 중국, 대만 등에서 활발하게 전개되고 있는 종목이다.", rulesUrl: "https://www.youtube.com/watch?v=U3yFGB8m8fQ", videoUrl: "https://www.youtube.com/watch?v=hjFYsvP3_8M"}, 
        {id: 6, koName: "스포츠스태킹", enName: "Sport Stacking", info: "스포츠스태킹은 1980년대 초 미국 서해안의 어린이들이 종이컵으로 놀이를 하던 것에서 유래되어 1990년대 중반에 스포츠로서의 체계를 구축하면서 교육현장에 보급되기 시작하였다. 12개의 스택컵을 다양한 방법으로 쌓고 또 허물어가는 기술과 스피드를 가려 집중력과 순발력을 요구하는 뉴스포츠이다.", rulesUrl: "https://www.youtube.com/watch?v=4wpsOs0Eluk", videoUrl: "https://www.youtube.com/watch?v=tZPen9QK9Hg"}, 
