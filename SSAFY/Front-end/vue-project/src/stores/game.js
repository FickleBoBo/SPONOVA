...
export const useGameStore = defineStore('gameInfo', () => { 
    ...
    const gameInfo = ref([
        ...
        {id: 2, koName: "소프트발리볼", enName: "Soft-Volleyball", info: "소프트 발리볼은 특수소재로 부드럽게 만들어진 볼을 6인제, 9인제 배구의 규정에 의해 배구의 즐거움을 맛볼 수 있도록 만든 뉴스포츠이다. 소프트발리볼 공은 우선 특이하게 생겨서 공과 쉽게 친해진다. 여학생들도 ‘아프지 않다’는 점 때문에 공을 좋아하게 된다. 혼자서 할 수 있는 플레이가 없는 경기이기 때문에 내가 잘 하기 위해서는 다른 팀원의 도움이 필요하다. 승패의 원인을 ‘우리’로 보게 하여, 경쟁보다는 팀워크에 관심을 갖게 한다."}, 
