...
CREATE TABLE Clubs (
    ClubID VARCHAR(20) NOT NULL UNIQUE PRIMARY KEY,			# 클럽 팀명
...
CREATE TABLE Users (
    ...
    UserRRN VARCHAR(7) NOT NULL,					    # 유저 주민등록번호
    UserPhonenumber VARCHAR(11) NOT NULL UNIQUE,		# 유저 전화번호
    UserNickname VARCHAR(10) NOT NULL UNIQUE,			# 유저 닉네임
    UserProfilePath VARCHAR(255),						# 유저 프로필 사진(경로)
    ClubID VARCHAR(20),									# 유저가 소속된 클럽
